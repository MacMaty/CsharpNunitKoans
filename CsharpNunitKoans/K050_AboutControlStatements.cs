...
namespace TheKoans
{
	...
	public class K050_AboutControlStatements : KoanHelper
	{
		...
		public void IfThenElseStatementsWithBrackets ()
		{
			...
			Assert.AreEqual (b, b, "To b or not to b -- that really is the answer...");
		}
		...
		public void IfThenElseStatementsWithoutBrackets ()
		{
			...
			Assert.AreEqual (b, b, "Unless the statement was break, continue or return, I would always use brackets to avoid confusion.");
		...
		public void IfThenStatementsWithBrackets ()
		{
			...
			Assert.AreEqual (b, b, "Brackets do not cause a racket; they provide clarity and potential for future statements.");
		}
		...
		public void IfThenStatementsWithoutBrackets ()
		{
			...
			Assert.AreEqual (b, b, "The code may look cleaner without them, but brackets help avoid confusion.");
		}
